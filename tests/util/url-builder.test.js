...
test("Replace file placeholders in URL template", (t) => {
	...
	t.is(
		buildUrl(filePath, data, "/[full_slug]"),
		"/content/_posts/example-post",
	);
...
test("Replace data placeholders with filters in URL template", (t) => {
	...
	t.is(
		buildUrl(filePath, data, "/url/{title|slugify|uppercase}/"),
		"/url/MY-TITLE/",
	);
});
...
test("Collapses placeholders with no value", (t) => {
	t.is(
		buildUrl(filePath, data, "/url/{nothing}/about.html"),
		"/url/about.html",
	);
});
